...
class GraphWin(tk.Canvas):
    ...
    def _onClick(self, e):
        ...
        if self._mouseCallback:
            self._mouseCallback(Point(e.j, e.i))
...
class _BBox(GraphicsObject):
    ...
    def _move(self, dx, dy):
        self.p1.j = self.p1.j + dx
        self.p1.i = self.p1.i + dy
        self.p2.j = self.p2.j + dx
        self.p2.i = self.p2.i + dy
    ...
    def getCenter(self):
        p1 = self.p1
        p2 = self.p2
        return Point((p1.j + p2.j) / 2.0, (p1.i + p2.i) / 2.0)
...
class Rectangle(_BBox):
    ...
    def _draw(self, canvas, options):
        p1 = self.p1
        p2 = self.p2
        x1,y1 = canvas.toScreen(p1.j, p1.i)
        x2,y2 = canvas.toScreen(p2.j, p2.i)
...
class Circle(Oval):
    ...
    def __init__(self, center, radius):
        p1 = Point(center.j - radius, center.i - radius)
        p2 = Point(center.j + radius, center.i + radius)
